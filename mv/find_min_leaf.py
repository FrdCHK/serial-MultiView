...
def find_min_leaf(norm_series, time_series, position, root, norm0, weight=1):
    """
    ...
    current_min, current_path = find_min_leaf(norm_series, time_series, position+1, root.current, norm0, weight)
    plus_min, plus_path = find_min_leaf(norm_series, time_series, position+1, root.plus, norm0, weight)
    minus_min, minus_path = find_min_leaf(norm_series, time_series, position+1, root.minus, norm0, weight)
